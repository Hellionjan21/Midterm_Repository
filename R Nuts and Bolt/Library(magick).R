...
################################################
####################MIDTERM#####################
data<-read.csv("C:/Users/user/Desktop/git/midetrmseatwork_data.csv")
data
...
image_crop(z,"295x320")
x<-image_read("https://upload.wikimedia.org/wikipedia/en/3/34/Fallout_New_Vegas.jpg")
print(x)
image_crop(x,"100x338")
image_scale(x,"400")
image_scale(x,"x400")
image_rotate(x,45)
image_flip(x)
image_flop(x)
library(magick)
url<-"https://upload.wikimedia.org/wikipedia/en/3/34/Fallout_New_Vegas.jpg"
image_read(url)
image_crop(url,"300x338+50")
url1<-"https://www.w3schools.com/w3css/img_lights.jpg"
image_read(url1)
image_crop(url1,"600x400+50")
image_trim(url1)
#LOCALLY
##LOADING IMAGE
library(imager)
...
library(jpeg)
library(png)
imgrotate<- function(imagelocation,rotate)
{
  pic<-load.image(imagelocation)
  rot<-imrotate(pic,rotate)
  plot(rot)
}
imgrotate("C:/Users/user/desktop/Ill-Ion.png",360)
###################################
...
imageview("C:/Users/RM A-225/knight.jpg")

######################################################################
######################################################################
###############COMBINATION OF RESIZE, GRAYSCALE,ROTATE################
library(png)
...
augment("C:/Users/RM A-225/knight.jpg",1000,1000,TRUE,90)
augment("C:/Users/user/desktop/Ill-Ion.png",1000,1000,TRUE,90)
...
library(devtools)
install("C:/Users/RM A-225/rPython-win-master/rPython-win-master")
